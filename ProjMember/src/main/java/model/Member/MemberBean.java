...
//			 System.out.println("select="+select.getArticleBean());
			//// 修改
	...
	public String toString() {
		return "MemberBean [memberID=" + memberID + ", account=" + account + ", pwd=" + Arrays.toString(pwd) + ", name=" + name + ", sex=" + sex + ", birthday=" + birthday + ", ID=" + ID + ", email="
				+ email + ", Celphone=" + Celphone + ", Telephone=" + Telephone + ", address=" + address + ", vip=" + vip + ", Bonus=" + Bonus + ", TotalBonus=" + TotalBonus + ", ssl=" + ssl
				+ ", MemberStatus=" + MemberStatus + ", BonusHistoryBean=" + BonusHistoryBean + ", BonusBean=" + BonusBean + "]";
	}
